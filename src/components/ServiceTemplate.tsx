  ...
  return (
    <div  className="container mx-auto px-4 py-16 flex flex-col md:flex-row gap-8 items-center bg-white">
      ...
      <div className="md:w-1/2 flex flex-col gap-4 text-right">
        <span className="bg-sky-100 text-sky-600 px-6 py-1 rounded-lg text-base font-bold self-end mb-2">الخدمة</span>
        ...
        {/* مزايا الخدمة */}
        <div dir='rtl'>
          <h2 className="text-xl font-bold text-blue-600 mb-2">2- مزايا الخدمة</h2>
